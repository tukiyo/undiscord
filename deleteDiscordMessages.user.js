...
<div id="undiscord" class="browser container redact" style="display:none;">
    ...
    <div class="window-body" style="display: flex; flex-direction: row;">
        ...
        <div class="main col">
            <div class="tbar col">
                <div class="row">
                    <button id="toggleSidebar" class="sizeMedium icon">笘ｰ</button>
                    <button id="start" class="sizeMedium danger" style="width: 150px;" title="Start the deletion process">笆ｶ・・Delete</button>
                    <button id="stop" class="sizeMedium" title="Stop the deletion process" disabled>尅 Stop</button>
	...
	class Draggable {
	  constructor(targetElm, handleElm, op, options) {
	    ...
	    const resizeOp = (x, y) => {
	      ...
	      if (op & RESIZE_T) { // resize 竊・
	        this._targetElm.style.top = t + 'px';
	        this._targetElm.style.height = h + 'px';
	      }
	      if (op & RESIZE_B) { // resize 竊・
	        this._targetElm.style.height = h + 'px';
	      }
	      if (op & RESIZE_L) { // resize 竊・
	        this._targetElm.style.left = l + 'px';
	        this._targetElm.style.width = w + 'px';
	      }
	      if (op & RESIZE_R) { // resize 竊・
	        this._targetElm.style.width = w + 'px';
	      }
	    };
